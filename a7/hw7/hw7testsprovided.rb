...
puts "test 24 passed? " + tests[24].to_s
...
puts "test 25 passed? " + tests[25].to_s
...
puts "test 56 passed? " + tests[56].to_s
...
puts Intersect.new(Line.new(ONE, ZERO), LineSegment.new(ZERO, ZERO, FOUR, FOUR)).preprocess_prog.eval_prog([])
puts "test 61 passed? " + tests[61].to_s
...
puts "test 65 passed? " + tests[65].to_s
...
puts "test 66 passed? " + tests[66].to_s
...
puts "test 70 passed? " + tests[70].to_s
...
puts "test 71 passed? " + tests[71].to_s
...
#puts Intersect.new(LineSegment.new(TWO, ZERO, TWO, FOUR), LineSegment.new(ZERO, TWO, FOUR, TWO)).preprocess_prog.eval_prog([])
puts "test 72 passed? " + tests[72].to_s
...
puts "test 73 passed? " + tests[73].to_s
...
puts "test 74 passed? " + tests[74].to_s
...
puts "test 75 passed? " + tests[75].to_s
...
puts "test 76 passed? " + tests[76].to_s
...
tests.each_with_index {|v,i| if (not v.nil?) and (not v) then puts "Test #{i}: #{v}" else puts "Test #{i} passed" end }
