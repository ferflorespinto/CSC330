...
in
	...
	then (print "1. preprocess flips an improper LineSegment successfully\n")
	else (print "1. preprocess does not flip an improper LineSegment successfully\n")
end;
...
in
	if real_equal(a,e) andalso real_equal(b,f) andalso real_equal(c,g) andalso real_equal(d,h)
	then (print "2. preprocess flips an improper LineSegment successfully\n")
	else (print "2. preprocess does not flip an improper LineSegment successfully\n")
end;
...
in
	if real_equal(a,e) andalso real_equal(b,f) andalso real_equal(c,g) andalso real_equal(d,h)
	then (print "3. preprocess flips an improper LineSegment successfully\n")
	else (print "3. preprocess does not flip an improper LineSegment successfully\n")
end;
...
in
	if real_equal(a,e) andalso real_equal(b,f) andalso real_equal(c,g) andalso real_equal(d,h)
	then (print "4. preprocess flips an improper LineSegment successfully\n")
	else (print "4. preprocess does not flip an improper LineSegment successfully\n")
end;
...
in
	if real_equal(a,e) andalso real_equal(b,f) andalso real_equal(c,g) andalso real_equal(d,h)
	then (print "5. preprocess flips an improper LineSegment successfully\n")
	else (print "5. preprocess does not flip an improper LineSegment successfully\n")
end;
(*---------------------------------PREPROCESS--------------------------*)
