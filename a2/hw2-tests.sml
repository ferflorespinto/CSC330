...
val mytest1_1=all_except_option("3",["4","9","10"]);
val test1_2=all_except_option("3",["4","9","3","10"]) = SOME ["4","9","10"];
val mytest1_2=all_except_option("3",["4","9","3","10"]);
...
val mytest2_1=get_substitutions1([["Fred","Fredrick"],["Elizabeth","Betty"],["Freddie","Fred","F"]],
                               "Fred");
...
val test3_1=get_substitutions2([["Fred","Fredrick"],["Elizabeth","Betty"],["Freddie","Fred","F"]],
                               "Fred")
            = ["Fredrick","Freddie","F"];
val mytest3_1=get_substitutions2([["Fred","Fredrick"],["Elizabeth","Betty"],["Freddie","Fred","F"]],
                               "Fred");

val test3_2=get_substitutions2([["Fred","Fredrick"],["Jeff","Jeffrey"],["Geoff","Jeff","Jeffrey"]],
                               "Jeff")
            = ["Jeffrey","Geoff","Jeffrey"];
val mytest3_2=get_substitutions2([["Fred","Fredrick"],["Jeff","Jeffrey"],["Geoff","Jeff","Jeffrey"]],
                               "Jeff");

val test3_3=get_substitutions2([["Neo","New"],["Panzer","Tank","Sherman"],["Tank", "Container"],["Epoch","Era"]],
                               "Tank")
            = ["Panzer","Sherman","Container"];
val mytest3_3=get_substitutions2([["Neo","New"],["Panzer","Tank","Sherman"],["Tank", "Container"],["Epoch","Era"]],
                               "Tank");

val test3_4=get_substitutions1([["Neo","New", "Nuovo"],["Panzer","Tank","Sherman"],["Tank", "Container"],["Epoch","Era"]],
                               "Neo")
            = ["New","Nuovo"];
val mytest3_4=get_substitutions1([["Neo","New", "Nuovo"],["Panzer","Tank","Sherman"],["Tank", "Container"],["Epoch","Era"]],
                               "Neo");
...
val mytest5_1= card_color(ClubAce);
...
val mytest11_1 = officiate(cards3, [], 10);
val test11_1 = officiate(cards3, [], 10) = 5;
val mytest11_2 = officiate(cards3, [Draw], 10);
val test11_2 = officiate(cards3, [Draw], 10) = 1;
val test11_3 = officiate(cards3, [Draw], 5) = 6;
val mytest11_4 = officiate(cards5, [Draw, Draw], 0);
...
val mytest11_7 = officiate(cards3, [Draw, Draw, Draw, Draw], 35);
...
val mytest11_9 = officiate(cards5, [Draw, Draw, Draw, Discard (Spades, Num 2)], 45);
...
val mytest11_11 = officiate(cards2, [Discard (Spades, Ace)], 10);
